...
if (isset($_SESSION['message'])) {
    ...
    echo "alertDiv.style.backgroundColor = 'green';";
    echo "alertDiv.style.color = 'white';";
    echo "alertDiv.style.padding = '10px';";
    echo "alertDiv.style.borderRadius = '5px';";
    echo "alertDiv.style.textAlign = 'center';"; // Center the text
    echo "alertDiv.style.margin = 'auto';"; // Center the div
    echo "alertDiv.textContent = message;";
